...
| Student Class  | deny_invite              | Allows a student to deny an invitation:<br/>Displays pending invitations using the see_invite method. <br/>Takes input for the lead ID to deny the invitation for. <br/>Updates the status of the corresponding invitation to 'denied'. **100%**                                                        | **100%**             | Student               |
